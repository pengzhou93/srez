...
tf.app.flags.DEFINE_string('train_dir', 'Set14',
...
tf.app.flags.DEFINE_float('gene_l1_factor', 1,
                          "Multiplier for generator L1 loss term")
# Learning rate subpixel
tf.app.flags.DEFINE_float('subpixel_learning_rate_start', 0.001,
                          "Starting learning rate used for AdamOptimizer")

tf.app.flags.DEFINE_integer('subpixel_decay_steps', 10000,
                            "Number of batches until learning rate is halved")

tf.app.flags.DEFINE_integer('subpixel_decay_rate', 0.1,
                            "Decay learning rate")
# learning rate GAN
tf.app.flags.DEFINE_float('gan_learning_rate_start',  0.01,
                          "Starting learning rate used for AdamOptimizer")

tf.app.flags.DEFINE_integer('gan_decay_steps', 20000,
                            "Number of batches until learning rate is halved")
...
def main(argv=None):
    ...
    if FLAGS.run == 'demo':
        ...
        with tf.Session() as sess:
            importlib.import_module('test').TEST(ckpt_path, TEST_DATA_PATH,sess)
